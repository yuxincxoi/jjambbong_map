        ...
        <div className={`w-80 ${className}`}>
          <div className="relative h-10 leading-[40px]">
            <input
              ...
              onChange={onChange}
              onFocus={handleFocus}
              className="absolute w-full outline-none px-4 leading-[40px] border-[1px] bg-transparent transition duration-100 z-1 rounded-md hover:border-main-color focus:border-main-color font-extralight peer"
            />
